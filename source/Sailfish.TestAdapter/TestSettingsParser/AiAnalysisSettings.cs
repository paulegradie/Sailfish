...
///     A Skipper transport must still be registered via <c>IRegisterSailfishServices</c>
///     (<c>services.AddSkipperTransport&lt;T&gt;()</c>); without one, enabling this is a no-op (the run is unaffected).
/// </summary>
