...
SF1024 | Sailfish.Usage | Error | TestCaseId constructor injection requires Lifetime = PerCase (under the default SharedInstance the constructor runs once per class)
