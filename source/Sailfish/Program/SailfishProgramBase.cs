...
public abstract class SailfishProgramBase
{
    ...
    [Option("-b|--before-target", CommandOptionType.SingleValue, Description = "A file name use to filter a specific tracking file for comparison when executing. This arg is passed to the BeforeAndAfterFileLocationCommand")]
    ...
    [Option("-s|--args", CommandOptionType.MultipleValue, Description = "A series of colon separated values that provide a key:value relationship. This collection is not used internally by Sailfish, but is provided to all command handlers. All args are parsed as string. Use like -s runName:test-run -s use-main:true")]
