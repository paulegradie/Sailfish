...
{
    public BeforeAndAfterFileLocationCommand(string trackingDirectory, OrderedDictionary<string, string> tags, string[] providedBeforeTrackingFiles, OrderedDictionary<string, string> args)
    {
    ...
    public string[] ProvidedBeforeTrackingFiles { get; }
