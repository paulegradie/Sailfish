...
public record PreprocessedData(double[] RawData, OutlierAnalysis? OutlierAnalysis);
...
public class TestPreprocessor : ITestPreprocessor
{
        ...
        int? seed = null)
    {
        if (useOutlierDetection)
        {
            ...
            return new PreprocessedData(rawData, new OutlierAnalysis(downSampled, outlierAnalysis.LowerOutliers, outlierAnalysis.UpperOutliers, outlierAnalysis.TotalNumOutliers));
        }
