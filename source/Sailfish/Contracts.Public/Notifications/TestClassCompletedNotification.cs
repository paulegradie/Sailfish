...
public record TestClassCompletedNotification : INotification
{
    public TestClassCompletedNotification(ClassExecutionSummaryTrackingFormat ClassExecutionSummaryTrackingFormat,
