...
public class ConvergenceChecksWithOutlierDetection
{
    ...
    public void TwoSampleWilcoxonSignedRankTestSailfish_NoChange()
    {
        ...
        for (var i = 0; i < 1000; i++)
        {
            ...
            results.Add(test.ExecuteTest(bf, af, new TestSettings(0.0001, 4, true, TestType.TwoSampleWilcoxonSignedRankTest)));
        }
    ...
    public void MannWhitneyWilcoxonTestSailfish_NoChange()
    {
        ...
        for (var i = 0; i < 20; i++)
        {
            results.Add(test.ExecuteTest(bf, af, new TestSettings(0.0001, 4, true, TestType.WilcoxonRankSumTest)));
        }
